package net.arjun.poolroomsmod.sound;
...
public class ModSounds {
    ...
    public static final RegistryKey<JukeboxSong> BAR_BRAWL_KEY =
            RegistryKey.of(RegistryKeys.JUKEBOX_SONG, Identifier.of(PoolRoomsMod.MOD_ID, "bar_brawl"));


    private static SoundEvent registerSoundEvent(String name) {
        Identifier id = Identifier.of(PoolRoomsMod.MOD_ID, name);
        return Registry.register(Registries.SOUND_EVENT, id, SoundEvent.of(id));
    }

    public static void registerSounds() {
        PoolRoomsMod.LOGGER.info("Registering Mod Sounds for " + PoolRoomsMod.MOD_ID);
    }
}
