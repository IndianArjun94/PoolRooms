package net.arjun.poolroomsmod.block;

import net.fabricmc.fabric.api.itemgroup.v1.ItemGroupEvents;
import net.arjun.poolroomsmod.PoolRoomsMod;
import net.arjun.poolroomsmod.block.custom.*;
import net.arjun.poolroomsmod.sound.ModSounds;
import net.arjun.poolroomsmod.world.tree.ModSaplingGenerators;
...
public class ModBlocks {
    ...
    private static Block registerBlock(String name, Function<AbstractBlock.Settings, Block> function) {
        Block toRegister = function.apply(AbstractBlock.Settings.create().registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(PoolRoomsMod.MOD_ID, name))));
        registerBlockItem(name, toRegister);
        return Registry.register(Registries.BLOCK, Identifier.of(PoolRoomsMod.MOD_ID, name), toRegister);
    }

    private static Block registerBlockWithoutBlockItem(String name, Function<AbstractBlock.Settings, Block> function) {
        return Registry.register(Registries.BLOCK, Identifier.of(PoolRoomsMod.MOD_ID, name),
                function.apply(AbstractBlock.Settings.create().registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(PoolRoomsMod.MOD_ID, name)))));
    }

    private static void registerBlockItem(String name, Block block) {
        Registry.register(Registries.ITEM, Identifier.of(PoolRoomsMod.MOD_ID, name),
                new BlockItem(block, new Item.Settings().useBlockPrefixedTranslationKey()
                        .registryKey(RegistryKey.of(RegistryKeys.ITEM, Identifier.of(PoolRoomsMod.MOD_ID, name)))));
    }

    public static void registerModBlocks() {
        PoolRoomsMod.LOGGER.info("Registering Mod Blocks for " + PoolRoomsMod.MOD_ID);
