package net.arjun.poolroomsmod.datagen;

import net.fabricmc.fabric.api.client.datagen.v1.provider.FabricModelProvider;
import net.fabricmc.fabric.api.datagen.v1.FabricDataOutput;
import net.arjun.poolroomsmod.block.ModBlocks;
import net.arjun.poolroomsmod.block.custom.CauliflowerCropBlock;
import net.arjun.poolroomsmod.block.custom.HoneyBerryBushBlock;
import net.arjun.poolroomsmod.block.custom.PinkGarnetLampBlock;
import net.arjun.poolroomsmod.component.ModDataComponentTypes;
import net.arjun.poolroomsmod.item.ModArmorMaterials;
