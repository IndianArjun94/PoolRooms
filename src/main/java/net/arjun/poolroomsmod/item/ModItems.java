package net.arjun.poolroomsmod.item;
...
import net.arjun.poolroomsmod.item.custom.ChiselItem;
import net.arjun.poolroomsmod.item.custom.HammerItem;
import net.arjun.poolroomsmod.item.custom.ModArmorItem;
import net.arjun.poolroomsmod.item.custom.TomahawkItem;
...
public class ModItems {
    ...
    private static Item registerItem(String name, Function<Item.Settings, Item> function) {
        return Registry.register(Registries.ITEM, Identifier.of(PoolRoomsMod.MOD_ID, name),
                function.apply(new Item.Settings().registryKey(RegistryKey.of(RegistryKeys.ITEM, Identifier.of(PoolRoomsMod.MOD_ID, name)))));
    }
    public static void registerModItems() {
        PoolRoomsMod.LOGGER.info("Registering Mod Items for " + PoolRoomsMod.MOD_ID);
